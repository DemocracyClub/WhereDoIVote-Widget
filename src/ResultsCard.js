...
function ResultsCard(props) {
    ...
    props.pollingStation.address.split(',').forEach(function(line, index) {
    ...
    return (
        <EmbedCard>
            ...
            {props.pollingStation.coordinates && (
                <Directions
                    origin={props.pollingStation.coordinates.origin}
                    destination={props.pollingStation.coordinates.destination}
                />
            )}
            <button href="#" onClick={props.home}>
