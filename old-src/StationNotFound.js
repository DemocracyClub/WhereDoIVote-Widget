            ...
            {props.council && (
                <div>
                    <span id="dc_get_in_touch">
                        Get in touch with{' '}
                        <b>
                            {props.council.council_id.startsWith('N09')
                    ...
                    <ul>
                        <li>
                            Website - <a href={props.council.website}>{props.council.website}</a>
                        </li>
                        <li>Phone - {props.council.phone}</li>
                        <li>
                            Email -{' '}
                            <a href={'mailto:' + props.council.email}>{props.council.email}</a>
                        </li>
                    </ul>
                    <br />
                </div>
